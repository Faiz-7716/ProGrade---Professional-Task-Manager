...
/**
 * @fileOverview Provides hashtag suggestions for LinkedIn posts.
 *
...
const SuggestHashtagsInputSchema = z.object({
  postContent: z.string().describe('The content of the LinkedIn post.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert social media manager specializing in LinkedIn.

  Given the following LinkedIn post content, suggest 10 relevant hashtags to maximize reach.
